...
WhatsApp ChatAPI do Kommo para conseguir backend/servidor para usar channel de Whatsapp (Api oficial) completo.  Architecture and commands to be documented as the codebase is built out.
